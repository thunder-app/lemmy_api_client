...
class _$ModTransferCommunityViewSerializer
  ...
  @override
  final Iterable<Type> types = const [ModTransferCommunityView];
  ...
  ModTransferCommunityView deserialize(
    ...
    return serializers.deserialize(serialized,
            specifiedType: FullType($ModTransferCommunityView))
        as $ModTransferCommunityView;
  }
}

/// a concrete implementation of [ModTransferCommunityView], since [ModTransferCommunityView] is not instantiable
