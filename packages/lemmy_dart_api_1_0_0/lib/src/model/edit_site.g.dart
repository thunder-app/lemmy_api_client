...
part of 'edit_site.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EditSite extends EditSite {
  @override
  ...
  @override
  final BuiltList<String>? blockedUrls;
  @override
  ...
  factory _$EditSite([void Function(EditSiteBuilder)? updates]) =>
      (new EditSiteBuilder()..update(updates))._build();
  ...
  @override
  EditSite rebuild(void Function(EditSiteBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EditSiteBuilder toBuilder() => new EditSiteBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EditSite &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EditSite')
...
class EditSiteBuilder implements Builder<EditSite, EditSiteBuilder> {
  _$EditSite? _$v;
  ...
  ListBuilder<String>? _blockedUrls;
  ListBuilder<String> get blockedUrls =>
      _$this._blockedUrls ??= new ListBuilder<String>();
  set blockedUrls(ListBuilder<String>? blockedUrls) =>
  ...
  EditSiteBuilder() {
    EditSite._defaults(this);
  }

  EditSiteBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EditSite other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EditSite;
  }

  @override
  void update(void Function(EditSiteBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EditSite build() => _build();
    ...
    try {
      _$result = _$v ??
          new _$EditSite._(
            ...
            blockedUrls: _blockedUrls?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EditSite', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
