...
// tests for CreateSite
void main() {
  final instance = CreateSiteBuilder();
  ...
  group(CreateSite, () {
    ...
    test('to test the property `enableDownvotes`', () async {
      // TODO
    });

    // bool enableNsfw
    test('to test the property `enableNsfw`', () async {
      // TODO
    });
    ...
    test('to test the property `defaultSortType`', () async {
      // TODO
    });
    ...
    // BuiltList<int> discussionLanguages
    ...
    test('to test the property `federationDebug`', () async {
      // TODO
    });
    ...
    // BuiltList<String> allowedInstances
    test('to test the property `allowedInstances`', () async {
      // TODO
    });

    // BuiltList<String> blockedInstances
    test('to test the property `blockedInstances`', () async {
      // TODO
    });
