...
class PrivateMessageResponseBuilder
  ...
  PrivateMessageViewBuilder? _privateMessageView;
  PrivateMessageViewBuilder get privateMessageView =>
      _$this._privateMessageView ??= new PrivateMessageViewBuilder();
  set privateMessageView(PrivateMessageViewBuilder? privateMessageView) =>
  ...
  PrivateMessageResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _privateMessageView = $v.privateMessageView.toBuilder();
      _$v = null;
    }
    return this;
  }
  ...
  _$PrivateMessageResponse _build() {
    _$PrivateMessageResponse _$result;
    try {
      _$result = _$v ??
          new _$PrivateMessageResponse._(
            privateMessageView: privateMessageView.build(),
          );
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'privateMessageView';
        privateMessageView.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'PrivateMessageResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
