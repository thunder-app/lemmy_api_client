...
class PrivateMessageReportResponseBuilder
  ...
  PrivateMessageReportViewBuilder? _privateMessageReportView;
  PrivateMessageReportViewBuilder get privateMessageReportView =>
      _$this._privateMessageReportView ??=
          new PrivateMessageReportViewBuilder();
  set privateMessageReportView(
          PrivateMessageReportViewBuilder? privateMessageReportView) =>
  ...
  PrivateMessageReportResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _privateMessageReportView = $v.privateMessageReportView.toBuilder();
      _$v = null;
    }
    return this;
  }
  ...
  _$PrivateMessageReportResponse _build() {
    _$PrivateMessageReportResponse _$result;
    try {
      _$result = _$v ??
          new _$PrivateMessageReportResponse._(
            privateMessageReportView: privateMessageReportView.build(),
          );
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'privateMessageReportView';
        privateMessageReportView.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'PrivateMessageReportResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
