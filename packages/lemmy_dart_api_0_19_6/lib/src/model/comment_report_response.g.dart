...
class CommentReportResponseBuilder
  ...
  CommentReportViewBuilder? _commentReportView;
  CommentReportViewBuilder get commentReportView =>
      _$this._commentReportView ??= new CommentReportViewBuilder();
  set commentReportView(CommentReportViewBuilder? commentReportView) =>
  ...
  CommentReportResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _commentReportView = $v.commentReportView.toBuilder();
      _$v = null;
    }
    return this;
  }
  ...
  _$CommentReportResponse _build() {
    _$CommentReportResponse _$result;
    try {
      _$result = _$v ??
          new _$CommentReportResponse._(
            commentReportView: commentReportView.build(),
          );
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'commentReportView';
        commentReportView.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'CommentReportResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
