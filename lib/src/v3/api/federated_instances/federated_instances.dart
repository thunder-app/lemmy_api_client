...
@freezed
class GetFederatedInstances with _$GetFederatedInstances implements LemmyApiQuery<GetFederatedInstancesResponse>, LemmyApiAuthenticatedQuery {
  @apiSerde
  const factory GetFederatedInstances({String? auth}) = _GetFederatedInstances;
