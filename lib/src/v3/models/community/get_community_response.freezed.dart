...
mixin _$GetCommunityResponse {
  ...
  List<CommunityModeratorView> get moderators => throw _privateConstructorUsedError; // v0.18.0
...
abstract class $GetCommunityResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({CommunityView communityView, Site? site, List<CommunityModeratorView> moderators, List<int> discussionLanguages});
...
class _$GetCommunityResponseCopyWithImpl<$Res, $Val extends GetCommunityResponse> implements $GetCommunityResponseCopyWith<$Res> {
  ...
  @override
  $Res call({Object? communityView = null, Object? site = freezed, Object? moderators = null, Object? discussionLanguages = null}) {
    return _then(
      _value.copyWith(
            communityView:
                null == communityView
...
class _$GetCommunityResponseImpl extends _GetCommunityResponse {
  const _$GetCommunityResponseImpl({required this.communityView, this.site, required final List<CommunityModeratorView> moderators, required final List<int> discussionLanguages})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, communityView, site, const DeepCollectionEquality().hash(_moderators), const DeepCollectionEquality().hash(_discussionLanguages));
