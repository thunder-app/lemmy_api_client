...
_$ModFeaturePostImpl _$$ModFeaturePostImplFromJson(Map<String, dynamic> json) => _$ModFeaturePostImpl(
...
Map<String, dynamic> _$$ModFeaturePostImplToJson(_$ModFeaturePostImpl instance) => <String, dynamic>{
  'id': instance.id,
