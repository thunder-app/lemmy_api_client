...
mixin _$SearchResponse {
  ...
  List<CommunityView> get communities => throw _privateConstructorUsedError; // v0.18.0
...
abstract class $SearchResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'type_') SearchType type, List<CommentView> comments, List<PostView> posts, List<CommunityView> communities, List<PersonView> users});
}
