...
_$LocalImageImpl _$$LocalImageImplFromJson(Map<String, dynamic> json) => _$LocalImageImpl(
...
Map<String, dynamic> _$$LocalImageImplToJson(_$LocalImageImpl instance) => <String, dynamic>{
