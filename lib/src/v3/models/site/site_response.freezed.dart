...
class _$SiteResponseCopyWithImpl<$Res, $Val extends SiteResponse> implements $SiteResponseCopyWith<$Res> {
  ...
  @override
  $Res call({Object? siteView = null, Object? taglines = null}) {
    return _then(
      _value.copyWith(
            siteView:
                null == siteView
...
class _$SiteResponseImpl extends _SiteResponse {
  const _$SiteResponseImpl({required this.siteView, required final List<Tagline> taglines}) : _taglines = taglines, super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, siteView, const DeepCollectionEquality().hash(_taglines));
...
abstract class _SiteResponse extends SiteResponse {
  const factory _SiteResponse({required final SiteView siteView, required final List<Tagline> taglines}) = _$SiteResponseImpl;
