...
_$SiteImpl _$$SiteImplFromJson(Map<String, dynamic> json) => _$SiteImpl(
  ...
  lastRefreshedAt: const ForceUtcDateTime().fromJson(json['last_refreshed_at'] as String),
...
Map<String, dynamic> _$$SiteImplToJson(_$SiteImpl instance) => <String, dynamic>{
  ...
  'last_refreshed_at': const ForceUtcDateTime().toJson(instance.lastRefreshedAt),
