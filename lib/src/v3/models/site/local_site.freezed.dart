...
mixin _$LocalSite {
  ...
  bool? get federationSignedFetch => throw _privateConstructorUsedError; // v0.19.0 (required)
  String? get defaultPostListingMode => throw _privateConstructorUsedError; // v0.19.4 (required)
