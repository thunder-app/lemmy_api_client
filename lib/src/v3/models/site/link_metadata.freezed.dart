...
mixin _$LinkMetadata {
  ...
  $LinkMetadataCopyWith<LinkMetadata> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LinkMetadataCopyWith<$Res> {
  factory $LinkMetadataCopyWith(LinkMetadata value, $Res Function(LinkMetadata) then) = _$LinkMetadataCopyWithImpl<$Res, LinkMetadata>;
  @useResult
  $Res call({String? title, String? description, String? image, String? embedVideoUrl, String? contentType});
}

/// @nodoc
class _$LinkMetadataCopyWithImpl<$Res, $Val extends LinkMetadata> implements $LinkMetadataCopyWith<$Res> {
...
/// @nodoc
abstract class _$$LinkMetadataImplCopyWith<$Res> implements $LinkMetadataCopyWith<$Res> {
  factory _$$LinkMetadataImplCopyWith(_$LinkMetadataImpl value, $Res Function(_$LinkMetadataImpl) then) = __$$LinkMetadataImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? title, String? description, String? image, String? embedVideoUrl, String? contentType});
}
...
/// @nodoc
class __$$LinkMetadataImplCopyWithImpl<$Res> extends _$LinkMetadataCopyWithImpl<$Res, _$LinkMetadataImpl> implements _$$LinkMetadataImplCopyWith<$Res> {
  __$$LinkMetadataImplCopyWithImpl(_$LinkMetadataImpl _value, $Res Function(_$LinkMetadataImpl) _then) : super(_value, _then);
...
class _$LinkMetadataImpl extends _LinkMetadata {
  const _$LinkMetadataImpl({this.title, this.description, this.image, this.embedVideoUrl, this.contentType}) : super._();

  factory _$LinkMetadataImpl.fromJson(Map<String, dynamic> json) => _$$LinkMetadataImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LinkMetadataImplCopyWith<_$LinkMetadataImpl> get copyWith => __$$LinkMetadataImplCopyWithImpl<_$LinkMetadataImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LinkMetadataImplToJson(this);
  }
}

abstract class _LinkMetadata extends LinkMetadata {
  const factory _LinkMetadata({final String? title, final String? description, final String? image, final String? embedVideoUrl, final String? contentType}) = _$LinkMetadataImpl;
  const _LinkMetadata._() : super._();

  factory _LinkMetadata.fromJson(Map<String, dynamic> json) = _$LinkMetadataImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$LinkMetadataImplCopyWith<_$LinkMetadataImpl> get copyWith => throw _privateConstructorUsedError;
}
