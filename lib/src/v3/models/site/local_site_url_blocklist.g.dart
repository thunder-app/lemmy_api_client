...
_$LocalSiteUrlBlocklistImpl _$$LocalSiteUrlBlocklistImplFromJson(Map<String, dynamic> json) => _$LocalSiteUrlBlocklistImpl(
  id: (json['id'] as num?)?.toInt(),
  url: json['url'] as String?,
  published: _$JsonConverterFromJson<String, DateTime>(json['published'], const ForceUtcDateTime().fromJson),
  updated: _$JsonConverterFromJson<String, DateTime>(json['updated'], const ForceUtcDateTime().fromJson),
);

Map<String, dynamic> _$$LocalSiteUrlBlocklistImplToJson(_$LocalSiteUrlBlocklistImpl instance) => <String, dynamic>{
  'id': instance.id,
  'url': instance.url,
  'published': _$JsonConverterToJson<String, DateTime>(instance.published, const ForceUtcDateTime().toJson),
