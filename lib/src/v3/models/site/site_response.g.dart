...
_$SiteResponseImpl _$$SiteResponseImplFromJson(Map<String, dynamic> json) => _$SiteResponseImpl(
...
Map<String, dynamic> _$$SiteResponseImplToJson(_$SiteResponseImpl instance) => <String, dynamic>{
