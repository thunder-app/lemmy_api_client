...
_$FederatedInstancesImpl _$$FederatedInstancesImplFromJson(Map<String, dynamic> json) => _$FederatedInstancesImpl(
  linked: (json['linked'] as List<dynamic>).map((e) => InstanceWithFederationState.fromJson(e as Map<String, dynamic>)).toList(),
  allowed: (json['allowed'] as List<dynamic>).map((e) => InstanceWithFederationState.fromJson(e as Map<String, dynamic>)).toList(),
  blocked: (json['blocked'] as List<dynamic>).map((e) => InstanceWithFederationState.fromJson(e as Map<String, dynamic>)).toList(),
);
