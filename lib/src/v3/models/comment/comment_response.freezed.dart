...
abstract class $CommentResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({CommentView commentView, List<int> recipientIds, @deprecated String? formId});
...
class _$CommentResponseCopyWithImpl<$Res, $Val extends CommentResponse> implements $CommentResponseCopyWith<$Res> {
  ...
  @override
  $Res call({Object? commentView = null, Object? recipientIds = null, Object? formId = freezed}) {
    return _then(
      _value.copyWith(
            commentView:
                null == commentView
...
class _$CommentResponseImpl extends _CommentResponse {
  const _$CommentResponseImpl({required this.commentView, required final List<int> recipientIds, @deprecated this.formId}) : _recipientIds = recipientIds, super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._recipientIds, _recipientIds) &&
            (identical(other.formId, formId) || other.formId == formId));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, commentView, const DeepCollectionEquality().hash(_recipientIds), formId);
...
abstract class _CommentResponse extends CommentResponse {
  const factory _CommentResponse({required final CommentView commentView, required final List<int> recipientIds, @deprecated final String? formId}) = _$CommentResponseImpl;
