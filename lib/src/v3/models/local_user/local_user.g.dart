...
_$LocalUserImpl _$$LocalUserImplFromJson(Map<String, dynamic> json) => _$LocalUserImpl(
  ...
  defaultCommentSortType: json['default_comment_sort_type'] == null ? null : SortType.fromJson(json['default_comment_sort_type']),
  defaultPostSortType: json['default_post_sort_type'] == null ? null : SortType.fromJson(json['default_post_sort_type']),
