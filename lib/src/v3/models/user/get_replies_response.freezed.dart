...
class _$GetRepliesResponseImpl extends _GetRepliesResponse {
  const _$GetRepliesResponseImpl({required final List<CommentReplyView> replies}) : _replies = replies, super._();
...
abstract class _GetRepliesResponse extends GetRepliesResponse {
  const factory _GetRepliesResponse({required final List<CommentReplyView> replies}) = _$GetRepliesResponseImpl;
