...
class _$GetPersonDetailsResponseImpl extends _GetPersonDetailsResponse {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, personView, site, const DeepCollectionEquality().hash(_comments), const DeepCollectionEquality().hash(_posts), const DeepCollectionEquality().hash(_moderates));
