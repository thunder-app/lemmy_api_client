...
mixin _$PersonAggregates {
  ...
  @deprecated
  int? get postScore => throw _privateConstructorUsedError; // v0.18.0 [deprecated in v0.19.0]
...
abstract class $PersonAggregatesCopyWith<$Res> {
  ...
  @useResult
  $Res call({@deprecated int? id, int personId, int postCount, @deprecated int? postScore, int commentCount, @deprecated int? commentScore});
}
...
class _$PersonAggregatesCopyWithImpl<$Res, $Val extends PersonAggregates> implements $PersonAggregatesCopyWith<$Res> {
  ...
  @override
  $Res call({Object? id = freezed, Object? personId = null, Object? postCount = null, Object? postScore = freezed, Object? commentCount = null, Object? commentScore = freezed}) {
    return _then(
      _value.copyWith(
            id:
                freezed == id
...
class _$PersonAggregatesImpl extends _PersonAggregates {
  const _$PersonAggregatesImpl({@deprecated this.id, required this.personId, required this.postCount, @deprecated this.postScore, required this.commentCount, @deprecated this.commentScore})
    : super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.postScore, postScore) || other.postScore == postScore) &&
            (identical(other.commentCount, commentCount) || other.commentCount == commentCount) &&
            (identical(other.commentScore, commentScore) || other.commentScore == commentScore));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, personId, postCount, postScore, commentCount, commentScore);
...
abstract class _PersonAggregates extends PersonAggregates {
  const factory _PersonAggregates({
    ...
    @deprecated final int? commentScore,
  }) = _$PersonAggregatesImpl;
