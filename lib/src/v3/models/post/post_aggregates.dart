...
class PostAggregates with _$PostAggregates {
  ...
  const factory PostAggregates({
    ...
    @deprecated String? newestCommentTimeNecro, // v0.18.0 [deprecated in v0.19.0]
    String? newestCommentTime, // v0.18.0, deprecated in v0.19.0, reintroduced in v0.19.2 (required)
