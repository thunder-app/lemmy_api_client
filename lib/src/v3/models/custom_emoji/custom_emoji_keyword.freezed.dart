...
class _$CustomEmojiKeywordCopyWithImpl<$Res, $Val extends CustomEmojiKeyword> implements $CustomEmojiKeywordCopyWith<$Res> {
  ...
  @override
  $Res call({Object? id = freezed, Object? customEmojiId = null, Object? keyword = null}) {
    return _then(
      _value.copyWith(
            id:
                freezed == id
...
class _$CustomEmojiKeywordImpl extends _CustomEmojiKeyword {
  const _$CustomEmojiKeywordImpl({@deprecated this.id, required this.customEmojiId, required this.keyword}) : super._();
...
abstract class _CustomEmojiKeyword extends CustomEmojiKeyword {
  const factory _CustomEmojiKeyword({@deprecated final int? id, required final int customEmojiId, required final String keyword}) = _$CustomEmojiKeywordImpl;
